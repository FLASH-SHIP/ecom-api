...
export default function CategoriesPage() {
  ...
  const { hasPermission: canCreate } = useRequirePermission([Permissions.CATEGORIES_CREATE]);
  const { hasPermission: canUpdate } = useRequirePermission([Permissions.CATEGORIES_UPDATE]);
  const { hasPermission: canDelete } = useRequirePermission([Permissions.CATEGORIES_DELETE]);
  ...
  return (
    <PermissionGuard permissions={[Permissions.CATEGORIES_READ]}>
