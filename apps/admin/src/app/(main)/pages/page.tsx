...
export default function PagesPage() {
  ...
  const { hasPermission: canCreate } = useRequirePermission([Permissions.PAGES_CREATE]);
  const { hasPermission: canUpdate } = useRequirePermission([Permissions.PAGES_UPDATE]);
  const { hasPermission: canDelete } = useRequirePermission([Permissions.PAGES_DELETE]);
  ...
  return (
    <PermissionGuard permissions={[Permissions.PAGES_READ]}>
                ...
                {isLoading ? (
                  ...
                  data.data.map((pg) => (
                    <>
                      ...
                      {editingId === pg.id && editPage && canUpdate && (
                        <tr key={`edit-${pg.id}`}>
