...
export default function PostsPage() {
  ...
  const { hasPermission: canCreate } = useRequirePermission([Permissions.POSTS_CREATE]);
  const { hasPermission: canUpdate } = useRequirePermission([Permissions.POSTS_UPDATE]);
  const { hasPermission: canDelete } = useRequirePermission([Permissions.POSTS_DELETE]);
  ...
  return (
    <PermissionGuard permissions={[Permissions.POSTS_READ]}>
