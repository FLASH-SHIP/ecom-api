...
export default function VerificationCodesContent() {
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <span className="text-xs text-muted-foreground">
            {formatDateTime(row.original.expiresAt, "DD-MM-YYYY HH:mm:ss")}
          </span>
        ),
      },
      {
        ...
        cell: ({ row }) => (
          <span className="text-xs text-muted-foreground">
            {formatDateTime(row.original.createdAt, "DD-MM-YYYY HH:mm:ss")}
          </span>
        ),
      },
    ],
  ...
  return (
    <>
      ...
      <DataTable<VerificationCodeRow>
        ...
        pageTitle={tNav("verificationCodes")}
        onRefresh={() => refetch()}
        emptyState={
