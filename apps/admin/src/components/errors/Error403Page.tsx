...
/**
 * Fuse-inspired 403 Forbidden error page.
 * SVG illustration: shield with forbidden sign - adapted from the 401 concept with a distinct "no access" visual.
 */
  ...
  return (
    <div className="flex min-h-svh flex-col items-center justify-center p-4">
      <div className="w-full max-w-xl text-center">
        <div className="animate-error-svg">
          ...
          >
            ...
            <polygon
              ...
              fill="#2f2e41"
            />
            {/* Shield with "no" sign instead of lock */}
            <circle cx="707.33457" cy="77.37523" r="77.37523" fill="currentColor" />
            <path
              d="M910.83 230.5a55 55 0 1 0 0 110 55 55 0 0 0 0-110zm0 100a45 45 0 1 1 0-90 45 45 0 0 1 0 90z"
              transform="translate(-203.5 -174.13424)"
              fill="#fff"
            />
            <rect
              ...
              rx="5"
              fill="#fff"
              transform="rotate(45 707.33 77.37)"
            />
            <path
            ...
            />
            <path
              d="M323.09819,563.26707v0a11.57378,11.57378,0,0,1,1.46928-9.36311l12.93931-19.85777a22.61221,22.61221,0,0,1,29.335-7.73927v0c-5.438,9.25647-4.67994,17.37679,1.87806,24.43365a117.63085,117.63085,0,0,0-27.93606,19.04492A11.57386,11.57386,0,0,1,323.09819,563.26707Z"
              transform="translate(-203.5 -174.13424)"
              fill="#2f2e41"
            />
            <path
        ...
        <Link href="/" className="mt-12 block text-center font-normal text-primary">
          {t("backToDashboard")}
        </Link>
      </div>
    </div>
