...
/**
 * Fuse-inspired 500 Server Error page.
 * SVG illustration: bug character + server rack + monitor.
 * Supports optional reset callback for use in Next.js error boundaries.
 */
  ...
  return (
    <div className="flex min-h-svh flex-col items-center justify-center p-4">
      <div className="w-full max-w-xl text-center">
        <div className="animate-error-svg">
          <svg
            width="100%"
            height="100%"
          ...
          >
            ...
            <g clipPath="url(#clip0_500)">
              {/* Trees/nature on the left */}
              <path
        ...
        <div className="animate-error-text">
          <h1 className="mt-12 text-center text-4xl font-extrabold leading-[1.25] tracking-tight md:text-7xl md:leading-none">
            {t("title")}
          </h1>
        </div>

        <div className="animate-error-text-delay">
          <p className="mt-2 text-center text-lg font-medium tracking-tight text-muted-foreground md:text-xl">
            {t("subtitle")}
          </p>
        </div>
