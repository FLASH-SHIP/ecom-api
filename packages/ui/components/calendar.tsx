...
import { Button, buttonVariants } from "@ecom/ui/components/button";
...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("cn-calendar group/calendar bg-background p-3", className)}
      ...
      components={{
        ...
        DayButton: ({ ...buttonProps }) => <CalendarDayButton locale={locale} {...buttonProps} />,
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        "outline-none focus:ring-[3px] focus:ring-ring/50 focus:ring-offset-0 focus-visible:ring-[3px] focus-visible:ring-ring/50 focus-visible:ring-offset-0",
