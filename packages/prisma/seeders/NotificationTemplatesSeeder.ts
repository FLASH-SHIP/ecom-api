...
export const NotificationTemplatesSeeder: Seeder = {
    ...
    for (const tpl of templates) {
      await prisma.notificationTemplate.upsert({
        ...
        update: {
          ...
          emailBodyTemplate: tpl.emailBodyTemplate,
          variables: tpl.variables,
          channelInApp: tpl.channelInApp,
          channelPush: tpl.channelPush,
          channelEmail: tpl.channelEmail,
        },
        create: {
          type: tpl.type,
          titleTemplate: tpl.titleTemplate,
