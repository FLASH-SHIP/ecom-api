import { dark, skyBlue } from "../@app/colors";
import type { AppThemesType } from "../@app/core/AppSettings/AppSettings";
...
/**
 * The themesConfig object is a configuration object for the color themes of the application.
 */
export const themesConfig: AppThemesType = {
  default: {
    palette: {
      mode: "light",
      // Default palette: primary dark + secondary blue #1565C0
